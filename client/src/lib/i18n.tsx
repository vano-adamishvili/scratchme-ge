...
const ka: Dictionary = {
  ...
  "nav.admin": "ადმინი",
  "nav.cart": "კალათა",
  "announcement": "ააწყე შენი ნაკრები: 3 პოსტერი = უფასო მიტანა · 4 პოსტერი = უფასო მიტანა და საჩუქარი",
  "hero.eyebrow": "გადასაფხეკი პოსტერები / თბილისი, საქართველო",
  "hero.title": "აქციე კედელი შენს ისტორიად.",
  "hero.body": "პოსტერები, რომლებიც შენთან ერთად იცვლება. თითოეული უჯრის უკან ახალი შთაბეჭდილებაა. გადაფხიკე ზედაპირი და ფერადად აღრიცხე შენი საყვარელი ფილმები, წაკითხული წიგნები და საუკეთესო მოგზაურობები და შენი კედელი, შენი შემდეგი ისტორია.",
  ...
  "bundle.builderBody": "აირჩიე ნაკრების ზომა, შემდეგ თავად მონიშნე ზუსტად ის პოსტერები, რომლებიც შენს ნაკრებში გინდა.",
  ...
  "bundle.complete": "ნაკრები შეივსო!",
  "bundle.review": "შეამოწმე არჩეული პოსტერები და დაამატე კალათაში.",
  "bundle.cancel": "ნაკრების გაუქმება",
  "bundle.addPackage": "დაამატე ნაკრები კალათაში",
  "bundle.pickMore": "აირჩიე კიდევ {count}",
  "bundle.packageAdded": "პერსონალური ნაკრები დაემატა კალათაში",
  ...
  "trust.title": "როგორ მუშაობს ScratchMe?",
  "trust.intro": "აირჩიე საყვარელი თემა, აღმოაჩინე ახალი იდეები და ყოველი მიღწევა პოსტერზე გადაფხიკვით აღნიშნე. ასე შენი პოსტერი ნელ-ნელა შენი თავგადასავლების ისტორიად იქცევა.",
  "trust.pick": "აირჩიე შენი თემა",
  "trust.pickBody": "ფილმები, წიგნები, მოგზაურობა თუ ახალი გამოწვევები — იპოვე პოსტერი, რომელიც შენს ინტერესებს შეეფერება.",
  "trust.scratch": "გამოსცადე და აღმოაჩინე",
  "trust.scratchBody": "უყურე ფილმს, წაიკითხე წიგნი, ეწვიე ადგილს ან შეასრულე გამოწვევა. პოსტერი ახალ იდეებსაც მოგცემს.",
  "trust.goals": "გადაფხიკე და შეინახე მოგონება",
  "trust.goalsBody": "ყოველი მიღწევის შემდეგ შესაბამისი უჯრა გადაფხიკე. ნახე, როგორ ივსება შენი პოსტერი პირადი ისტორიებით.",
  "trust.story": "ეს უბრალოდ სია არ არის — ეს შენი აღმოჩენებისა და მიღწევების თვალსაჩინო ისტორიაა.",
  "trust.cta": "აირჩიე პოსტერი",
  ...
  "product.fastBody": "3 პოსტერის შეკვეთაზე მიტანა უფასოა; 4 პოსტერზე — უფასო მიტანა და საჩუქარი.",
  ...
  "contact.formNote": "შეტყობინება პირდაპირ გაიგზავნება scratchmege@gmail.com-ზე.",
  "contact.emailCta": "მოგვწერე ელფოსტაზე",
  "contact.messengerCta": "მოგვწერე Messenger-ში",
...
const en: Dictionary = {
  ...
  "contact.eyebrow": "Get in touch / Tbilisi, Georgia", "contact.title": "Write to us.\nLet’s make it happen.", "contact.body": "Questions about an order, a collaboration, a custom poster, or simply an idea to share — we’re here.", "contact.formEyebrow": "Send us a note", "contact.formTitle": "How can we help?", "contact.formBody": "Tell us what you have in mind and we’ll get back to you soon.", "contact.name": "Name", "contact.email": "Email", "contact.message": "Message", "contact.send": "Send message", "contact.formNote": "Your message will be sent directly to scratchmege@gmail.com.", "contact.emailCta": "Email us", "contact.messengerCta": "Message on Messenger", "contact.detailsEyebrow": "Where & when", "contact.detailsTitle": "Come say hello.", "contact.addressLabel": "Address", "contact.address": "Tbilisi, Georgia", "contact.hoursLabel": "Opening hours", "contact.hours": "Every day · 09:00–20:00", "contact.emailLabel": "Email", "contact.socialEyebrow": "Follow along", "contact.socialTitle": "More scratchme, every day.", "contact.socialBody": "Follow our pages for new posters, ideas, and offers.", "contact.socialFollow": "Follow / გამოწერა", "contact.socialCount": "Followers", "contact.messengerTitle": "Message us on Messenger", "contact.messengerBody": "Quick answers about orders and questions", "contact.socialCountNote": "Follower counts are managed and updated from the Admin panel.",
};
