...
export function BundleSelectionDock() {
  ...
  const complete = remaining === 0 && (bundleDraft.tier !== 4 || Boolean(bundleDraft.gift && giftLabels[bundleDraft.gift].active !== false && giftStock[bundleDraft.gift] > 0));
  const submit = () => {
