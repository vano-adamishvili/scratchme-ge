...
export function Footer() {
  ...
  return <footer className="footer" id="contact"><div className="container"><div className="footer-grid">
    ...
    <div><h4>{t("footer.help")}</h4><a href="mailto:hello@scratchme.ge">hello@scratchme.ge</a><a href="tel:+995555123456">+995 555 12 34 56</a><span className="footer-contact-line">თბილისი, საქართველო</span><a href="/contact">{t("nav.contact")}</a></div>
