...
export const storeSettings = mysqlTable("store_settings", { id: int("id").autoincrement().primaryKey(), bankName: varchar("bankName", { length: 100 }).default("TBC Bank").notNull(), iban: varchar("iban", { length: 64 }).default("").notNull(), receiverName: varchar("receiverName", { length: 160 }).default("").notNull(), secondBankName: varchar("secondBankName", { length: 100 }).default("საქართველოს ბანკი").notNull(), secondIban: varchar("secondIban", { length: 64 }).default("").notNull(), secondReceiverName: varchar("secondReceiverName", { length: 160 }).default("").notNull(), shippingFee: decimal("shippingFee", { precision: 10, scale: 2 }).default("5.00").notNull(), giftStickersStock: int("giftStickersStock").default(100).notNull(), giftMagnetStock: int("giftMagnetStock").default(100).notNull(), giftPinStock: int("giftPinStock").default(100).notNull(), updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull() });
